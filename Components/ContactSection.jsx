        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-bold text-white leading-tight">
              Let's Make<br />
              Something <span className="text-[#6A35FF]">Amazing Together!</span>
            </motion.h2>
            ...
            <motion.div variants={itemVariants} className="space-y-4 pt-4">
              <div className="lg:flex items-center space-x-5 space-y-4 lg:space-y-0">
                ...
                <div className="flex items-center gap-2 group cursor-pointer">
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-2xl text-[#6A35FF] group-hover:scale-110 transition-transform duration-300" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
              ...
              <form className="space-y-6" onSubmit={submitForm}>
                <div className="group">
                  <input 
                    ...
                    className="w-full px-0 py-3 text-gray-900 placeholder-gray-500 border-0 border-b-2 border-gray-200 focus:border-[#6A35FF] focus:ring-0 focus:outline-none bg-transparent transition-colors duration-300" 
                    type="text" 
                    name="fullName"
                ...
                <div>
                  <textarea 
                    ...
                    placeholder="Message" 
                    rows="4" 
                    className="w-full px-0 py-3 text-gray-900 placeholder-gray-500 border-0 border-b-2 border-gray-200 focus:border-[#6A35FF] focus:ring-0 focus:outline-none bg-transparent resize-none transition-colors duration-300"
                ...
                <div className="relative inline-block w-full">
                  <button 
                    ...
                    className="w-full sm:w-auto border rounded-lg font-bold cursor-pointer transition-all duration-300 ease-in-out bg-[#6A35FF] text-white border-[#6A35FF] hover:bg-[#5229cf] hover:shadow-lg text-sm sm:text-md py-3 px-6 sm:px-8 lg:px-10 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
